        ...
        <div className="grid gap-4 mx-4 sm:grid-cols-12">
          <div className="col-span-12 sm:col-span-3">
            <div className="text-center sm:text-left mb-14 before:block before:w-24 before:h-3 before:mb-5 before:rounded-md before:mx-auto sm:before:mx-0 before:bg-violet-600">
              <h3 className="text-3xl font-semibold">Project Timeline</h3>
              <span className="text-sm font-bold tracking-wider uppercase text-gray-600">Latest Projects</span>
            </div>
          </div>
          <div className="relative col-span-12 px-4 space-y-6 sm:col-span-9">
            ...
            {projects.map((project, index) => (
              <Link to={`/projects#${project.id}`} key={index} className="block">
                ...
                >
                  <div className='hover:scale-110 p-4 bg-black rounded-lg cursor-pointer'>
                    <h3 className="text-xl font-semibold tracking-wide">{project.title}</h3>
                    <time className="text-xs tracking-wide uppercase text-gray-600">{project.date}</time>
