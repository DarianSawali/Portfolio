...
//   return (
//     <>
//       <aside className={`h-screen top-0 ${expanded ? 'fixed' : 'sticky'} ${expanded ? 'w-48' : 'w-16'} md:${expanded ? 'w-64' : 'w-12'} lg:${expanded ? 'w-64' : 'w-8'} transition-all duration-300 z-50 bg-zinc-900 shadow-sm`}>
//         <nav className="h-full flex flex-col">
//           <div className="p-4 pb-2 flex justify-between items-center">
//             <span className={`overflow-hidden transition-all text-gray-300 ${expanded ? "w-16" : "w-0"}`}>DS</span>
//             <button onClick={() => setExpanded((curr) => !curr)} className="p-1 rounded-lg text-white bg-transparent">
//               {expanded ? <ChevronFirst /> : <ChevronLast />}
//             </button>
//           </div>
...
//         </nav>
//       </aside>
//       {expanded && <div onClick={() => setExpanded(false)} className="fixed inset-0 bg-black opacity-50 z-40"></div>}
//     </>
//   );
// }
...
//   return (
//     <>
//       <aside className={`h-screen top-0 ${expanded ? 'fixed' : 'sticky'} ${expanded ? 'w-48' : 'w-16'} md:${expanded ? 'w-64' : 'w-12'} lg:${expanded ? 'w-64' : 'w-8'} transition-all duration-300 z-50`}>
